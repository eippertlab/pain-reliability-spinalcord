function Denoising_T1(packagepath, flag, method, beta, patchradius, searchradius, suffixfile, rician, namein, pathin)
disp(packagepath)
disp(namein)
% this code is taken from the MRI Denoising Package
