...
for subject in range(1, 5):
    ...
    for session in range(1, 3):
        ...
        file_pattern = f'{data_dir}{sub}*events.tsv'
...
pd.to_pickle(data, f'{out_dir}rating_CombinedRuns.pickle')

#%% import data
ratings = pd.read_pickle(f'{out_dir}rating_CombinedRuns.pickle')
ratings_avg = []
...
#%% Subjective and peripheral physiological responses, Ratings, CombinedRuns
...
with sns.plotting_context('paper', font_scale = 2):
    ...
    plt.savefig(f'{out_dir}heateffect_rating_CombinedRuns.png', bbox_inches='tight', format="png", dpi=300)
    plt.show()
